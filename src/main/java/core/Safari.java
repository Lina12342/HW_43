...
public class Safari {
	...
	public static void main(String[] args) throws IOException {
		...
		if (!System.getProperty("os.name").toUpperCase().contains("MAC"))
			throw new IllegalArgumentException("Browser doesn't exist for this OS");
		...
		String[] idElementIndex = p.getProperty("id_ind").split(",");
		String[] nameElementIndex = p.getProperty("name_ind").split(",");
		...
		String[] idElementConf = p.getProperty("id_c").split(",");
		String[] nameElementConf = p.getProperty("name_c").split(",");
